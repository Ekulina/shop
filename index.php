...
<div class="d-flex flex-row-reverse m-5" id="nav">
    <a href="cart.php" class="btn btn-warning">
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
    ...
    <?php if (!empty($products)) : foreach ($products as $product) { ?>
        <div class="card m-4" style="width: 18rem;">
            ...
            <div class="d-flex flex-column card-body justify-content-end">
                ...
                <a class="btn btn-warning" href="add.php?id=<?php echo $product['id']; ?>">Add to cart</a>
            </div>
        </div>
    <?php } endif; ?>
</div>
